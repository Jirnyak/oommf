...
We actively maintain and provide security patches for the following versions of **Jirnyak/oommf**:
...
Security audits for **Jirnyak/oommf** focus on the following attack surfaces and failure modes:

1. **Floating-Point NaN Cascades**:  High damping parameters causing division by zero in precession calculations.
2. **Buffer Overflows in Mesh Loaders**:  Parsing untrusted .omf/.mif magnetic configuration input files.
3. **Race Conditions in Multi-GPU Compute**:  Unsynchronized peer-to-peer memory transfers across CUDA streams.

---

## 🚨 3. Reporting a Vulnerability

If you discover a security vulnerability or exploit in **Jirnyak/oommf**, please report it responsibly:
